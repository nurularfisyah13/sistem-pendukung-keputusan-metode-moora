        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
          <div class="card card-signin my-5">
            <div class="card-body">
              ...
              <h5 class="card-title text-center">Masuk Sebagai <b>Penilai</b></h5>
...
<form class="form-signin user" method="post">
  ...
  <a class="btn btn-lg btn-danger btn-block text-uppercase shadow" href="login_admin.php" type="submit">Masuk sebagai Admin</a>
</form>
</div>
</div>
</div>
