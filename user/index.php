...
<header class="masthead  ">
    <div class="container mb-xl-5 mt">
        <div class="row align-items-center">
                ...
                <h1 class="mb-4">Selamat datang <i><?php echo (!empty($_SESSION['username'])) ? $_SESSION['username'] : 'USER'; ?></i> di Program SPK Pemilihan Kue Terfavorit dengan Metode MOORA!</h1>
                <h2 class="m-0">Dashboard Ini merupakan halaman Awal dari Sistem Pendukung Keputusan Pemilihan Kue Terfavorit di Trans Family</h2>
