    ...
    <div id="content">
      ...
      <header class="masthead  ">
        <div class="container  ">
          <div class="card-deck ">
            <div class="col">
              <div class="card mb-3 boxgreen rounded box shadow" style="background: #e3a95d;">
                ...
                <div class="card-body  ">
                  ...
                  <p class="card-text h6 mb-3 mt-md-4 text-center text-white ">
                    Data Kue yang telah terdaftar di sistem </p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card text-white rounded shadow-lg" style="background: #e3a95d;">
                <div class="card-body">
                  <p class="card-text  text-center text-white mb-xl-1 " style="font-size: 70px;">
