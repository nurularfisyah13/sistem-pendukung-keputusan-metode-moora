              ...
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-xl-6" style="text-align: right;">
                    <a class="btn btn-primary shadow" href="data_kue_tambah.php">
                    <span class="icon ">
                              <i class="fas fa-user-plus mr-lg-2"></i>
                            </span>Tambah Data Kue</a>
                  </div>
                </div>
              </div>
                ...
                <table border="border-left-info" class=" shadow table table-bordered table-striped table table-hover table-sm " id="dataTable" >
                  ...
                  <tbody>
                    <?php
                      ...
                      <td align="center" style="width: 35.66%"><?php echo $row['namasiswa']; ?></td>
                      <td align="center" style="width: 15.66%"><?php echo ($row['penghasilan']);?></td>
					  <td align="center" style="width: 15.66%"><?php echo ($row['jarak']);?></td>
					  <td align="center" style="width: 15.66%"><?php echo ($row['tanggungan']);?></td>
					  <td align="center" style="width: 15.66%"><?php echo ($row['pendidikan']);?></td>
					  <td align="center" style="width: 15.66%"><?php echo ($row['ratanilai']);?></td>
                      
                        <td align="center" style="width: 1.66%">
                          <a class="btn btn-outline-info btn-sm  border-0"
                            href="data_kue_ubah.php?id_siswa=<?php echo $row['id_siswa'] ?>">
                            <span class="icon">
                              <i class="fas fa-edit"></i>
                            </span>
                          </a>
                          <a class="btn btn-info  btn-sm btn-outline-danger border-0"
                            href="data_kue_hapus.php?id_siswa=<?php echo $row['id_siswa'] ?>">
                            <span class="icon">
