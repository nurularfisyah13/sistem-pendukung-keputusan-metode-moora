...
<?php
$sql    = "SELECT MAX(id_admin) AS maxid FROM admin_acc";
                                ...
                                <form class="form" method="post" name="converter">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input class="form-control" type="text" name="id_admin" value="<?= $kodeoto ?>" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-12 col-sm-12 col-xs-12">Nama Admin</label>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col text-center m">
                                            ...
                                            <a href="registrasi_administrator.php" class="btn btn-danger">Batal</a>
                                </form>
                            </div>
                        </div>
                    </div>
...
if (isset($_POST['simpan'])) {
    ...
    $sql_alat   = "SELECT * FROM admin_acc WHERE username = '$username'";
    ...
    if ($cek_alat > 0) {
        ...
        $query  = "INSERT INTO admin_acc (id_admin, nama_admin, username, password, level) VALUES ('$id_admin','$nama_admin', '$username','$password','$level')";
