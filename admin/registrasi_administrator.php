          ...
          <div class="col-lg-12 col-xl-12">
            <div class="card shadow mb-4">
              <div class="card-header">
                <div class="row">
                  <div class="col">
                    <h5 class="mt-2 font-weight-bold text-primary"> <b> Pengaturan Akun Admin </b></h5>
                  </div>
                  <div class="col-lg-6 col-xl-6" style="text-align: right;">
                    <a class="btn btn-primary shadow" href="registrasi_administrator_tambah.php"> <span class="icon ">
                              <i class="fas fa-user-plus mr-lg-2"></i>Tambah Akun Admin</a>
                  </div>
                </div>
              </div>
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <a class="btn btn-outline-info btn-sm mb-2  border-0"
                            href="registrasi_administrator_ubah.php?id_admin=<?php echo $row['id_admin'] ?>">
                            <span class="icon">
                              <i class="fas fa-edit"></i>
                            </span>
                          </a>
                          <a class="btn btn-info  btn-sm mb-2  border-0 btn-outline-danger"
                            href="registrasi_administrator_hapus.php?id_admin=<?php echo $row['id_admin'] ?>">
                            <span class="icon">
